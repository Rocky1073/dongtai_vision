      ...
      function(a, b, c) {
        ...
        return (
          ...
          (q.staggerFrom = function(a, b, c, d, e, f, g, h) {
            return (
              (c.immediateRender = 0 != c.immediateRender), (c.runBackwards = !0), this.staggerTo(a, b, c, d, e, f, g, h)
            );
          }),
                ...
                h &&
                  (this._gc ||
                    ((p === this._startTime || q !== this._timeScale) &&
                      ...
                      (f &&
                        (j.length && k(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)),
      ...
      var a = 180 / Math.PI,
        ...
        p = _gsScope._gsDefine.plugin({
          ...
          set: function(b) {
            ...
            if (this._timeRes) {
              if (
                ((k = this._lengths), (l = this._curSeg), (b *= this._length), (e = this._li), b > this._l2 && m - 1 > e)
              ) {
        ...
        for (
          ya('clearProps', {
            parser: function(a, b, d, e, f) {
              return (
                (f = new ta(a, d, 0, 0, f, 2)), (f.setRatio = Xa), (f.e = b), (f.pr = -10), (f.data = e._tween), (c = !0), f
              );
            },
          }),

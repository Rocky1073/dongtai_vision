...
setInterval(function() {
  var rate = 0.4 + 0.2 * Math.random();
  mylianlv.setOption(option);
}, 2000);

/*处置率*/
/*表盘配置项*/
var crate = 0.4 + 0.3 * Math.random(); //rate为【0,1】间的数
var clinear_color = {
  type: 'linear',
  x: 1,
  y: 0,
...
setInterval(function() {
  var crate = 0.4 + 0.2 * Math.random();
  chuzhilv.setOption(coption);
}, 2000);

/*按时结案率*/
/*表盘配置项*/
var arate = 0.4 + 0.3 * Math.random(); //rate为【0,1】间的数
var alinear_color = {
  type: 'linear',
  x: 1,
  y: 0,
...
setInterval(function() {
  var arate = 0.4 + 0.2 * Math.random();
  anshilv.setOption(aoption);
}, 2000);
/*按时结案率0*/
/*表盘配置项*/
var jrate = 0.4 + 0.3 * Math.random(); //rate为【0,1】间的数
var jlinear_color = {
  type: 'linear',
  x: 1,
  y: 0,
